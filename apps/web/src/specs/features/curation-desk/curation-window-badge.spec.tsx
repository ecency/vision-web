...
function renderRow(row: DeskRow) {
  return renderWithQueryClient(
    <CurationQueueRow row={row} isActive={false} isRoster={false} isTrial={false} username="member1" recommendationsEnabled coarsePointer={false} section="queue" late={false} resurfaced={false} belowCursor={false} reviewedByCursor={false} chronological {...rowWindowProps(row)} {...actions} />
  );
}
