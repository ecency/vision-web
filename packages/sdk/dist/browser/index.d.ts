 ...
 */
declare function getAiImagesQueryOptions(username: string | undefined, accessToken: string): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<AiImageHistoryItem[], Error, AiImageHistoryItem[], readonly ["ai", "images", string | undefined]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<AiImageHistoryItem[], readonly ["ai", "images", string | undefined], never> | undefined;
} & {
    queryKey: readonly ["ai", "images", string | undefined] & {
        [dataTagSymbol]: AiImageHistoryItem[];
        [dataTagErrorSymbol]: Error;
    };
};
 ...
 */
declare function getAiTranscribePriceQueryOptions(username: string | undefined, accessToken: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<AiTranscribePrice, Error, AiTranscribePrice, readonly ["ai", "transcribe-price", string | undefined]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<AiTranscribePrice, readonly ["ai", "transcribe-price", string | undefined], never> | undefined;
} & {
    queryKey: readonly ["ai", "transcribe-price", string | undefined] & {
        [dataTagSymbol]: AiTranscribePrice;
        [dataTagErrorSymbol]: Error;
    };
};
...
declare function invalidateGenerateImageCaches(username: string): void;
 ...
 */
declare function useAiTranscribe(username: string | undefined, accessToken: string | undefined): _tanstack_react_query.UseMutationResult<AiTranscribeResponse, Error, AiTranscribeParams, unknown>;
 ...
 */
declare function broadcastOperationsAsync(ops: Operation[], key: PrivateKey): Promise<BroadcastResult>;
...
interface PlatformAdapter {
     ...
     * ```
     */
    showAuthUpgradeUI?: (requiredAuthority: 'posting' | 'active', operation: string) => Promise<'hiveauth' | 'hivesigner' | 'keychain' | 'key' | false>;
    /**
 ...
 */
declare const BROADCAST_INCLUSION_DELAY_MS = 4000;
/**
 ...
 */
declare function invalidateAfterBroadcast(adapter: PlatformAdapter | null | undefined, broadcastMode: BroadcastMode | undefined, keys: any[][]): void | Promise<void>;
 ...
 */
declare const SERVER_GC_TIME_MS: number;
...
declare const QueryKeys: {
    ...
    readonly accounts: {
        ...
        readonly favoriteTags: (activeUsername?: string) => (string | undefined)[];
        readonly favoriteTagsInfinite: (activeUsername?: string, limit?: number) => unknown[];
        readonly checkFavoriteTag: (activeUsername: string, tag: string) => string[];
        ...
        readonly proMembers: () => string[];
        readonly _prefix: readonly ["accounts"];
    };
    readonly notifications: {
        readonly announcements: () => string[];
        readonly spotlights: () => string[];
    ...
    readonly communities: {
        ...
        readonly subscribersInfinite: (communityName: string) => string[];
    ...
    readonly search: {
        ...
        readonly similarEntries: (author: string, permlink: string, content?: string) => string[];
    ...
    readonly quests: {
        readonly status: (username: string | undefined) => (string | undefined)[];
    };
    readonly newsletter: {
        readonly subscriptions: (username: string | undefined) => (string | undefined)[];
        readonly sender: (type: string, target: string, username: string | undefined) => (string | undefined)[];
        readonly issues: (type: string, target: string, username: string | undefined) => (string | undefined)[];
        readonly posts: (type: string, target: string, username: string | undefined, limit: number) => (string | number | undefined)[];
        readonly _prefix: readonly ["newsletter"];
    };
    readonly support: {
        readonly settings: (username: string | undefined) => (string | undefined)[];
        readonly _prefix: readonly ["support"];
    };
    readonly badActors: {
        readonly list: () => string[];
    ...
    readonly curation: {
         ...
         */
        readonly application: (username: string | undefined) => (string | undefined)[];
        readonly applications: (username: string | undefined, state?: string) => (string | undefined)[];
        readonly applicationsPrefix: () => string[];
    ...
    readonly ai: {
        ...
        readonly transcribePrice: (username?: string) => readonly ["ai", "transcribe-price", string | undefined];
        readonly images: (username?: string) => readonly ["ai", "images", string | undefined];
...
interface TransferFromSavings extends BaseTransaction {
...
interface FillTransferFromSavings extends BaseTransaction {
...
declare function addFavoriteTagRequest(username: string | undefined, code: string | undefined, tag: string): Promise<AccountFavoriteTag[]>;
/** Unfollow a hashtag. Resolves to the updated list, newest first. */
declare function deleteFavoriteTagRequest(username: string | undefined, code: string | undefined, tag: string): Promise<AccountFavoriteTag[]>;

declare function useFavoriteTagAdd(username: string | undefined, code: string | undefined, onSuccess: () => void, onError: (e: Error) => void): _tanstack_react_query.UseMutationResult<AccountFavoriteTag[], Error, string, unknown>;
 ...
 */
declare function favoriteTagDeleteMutationOptions(username: string | undefined, code: string | undefined, onSuccess: () => void, onError: (e: Error) => void): UseMutationOptions<AccountFavoriteTag[], Error, string, DeleteContext | undefined>;
declare function useFavoriteTagDelete(username: string | undefined, code: string | undefined, onSuccess: () => void, onError: (e: Error) => void): _tanstack_react_query.UseMutationResult<AccountFavoriteTag[], Error, string, DeleteContext | undefined>;
 ...
 */
declare function buildRcDelegationOp(user: string, duration: number): Operation;
/**
 ...
 * @param code - Access token for authentication
 */
declare function getFavoriteTagsQueryOptions(activeUsername: string | undefined, code: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<AccountFavoriteTag[], Error, AccountFavoriteTag[], (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<AccountFavoriteTag[], (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: AccountFavoriteTag[];
        [dataTagErrorSymbol]: Error;
    };
};
declare function getFavoriteTagsInfiniteQueryOptions(activeUsername: string | undefined, code: string | undefined, limit?: number): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseInfiniteQueryOptions<WrappedResponse<AccountFavoriteTag>, Error, _tanstack_react_query.InfiniteData<WrappedResponse<AccountFavoriteTag>, unknown>, unknown[], number>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<WrappedResponse<AccountFavoriteTag>, unknown[], number> | undefined;
} & {
    queryKey: unknown[] & {
        [dataTagSymbol]: _tanstack_react_query.InfiniteData<WrappedResponse<AccountFavoriteTag>, unknown>;
        [dataTagErrorSymbol]: Error;
    };
};
 ...
 */
declare function getFavoriteTagCheckQueryOptions(activeUsername: string | undefined, code: string | undefined, tag: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<boolean, Error, boolean, string[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<boolean, string[], never> | undefined;
} & {
    queryKey: string[] & {
        [dataTagSymbol]: boolean;
...
declare function getAccountRecoveriesQueryOptions(username: string | undefined, code: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<GetRecoveriesEmailResponse[], Error, GetRecoveriesEmailResponse[], string[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<GetRecoveriesEmailResponse[], string[], never> | undefined;
} & {
    queryKey: string[] & {
...
declare function getAccountPendingRecoveryQueryOptions(username: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<any, Error, any, string[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<any, string[], never> | undefined;
} & {
    queryKey: string[] & {
        [dataTagSymbol]: any;
...
type DraftRewardType = "default" | "sp" | "dp";
...
type BalanceAggregationGranularity = "yearly" | "monthly" | "daily";
/**
 ...
 */
declare function getAggregatedBalanceQueryOptions(username?: string, coinType?: BalanceCoinType, granularity?: BalanceAggregationGranularity): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<AggregatedBalanceEntry[], Error, AggregatedBalanceEntry[], string[]>, "queryFn"> & {
...
declare function getProMembersQueryOptions(): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<ProMembersResponse, Error, ProMembersResponse, string[]>, "queryFn"> & {
    ...
    queryKey: string[] & {
        [dataTagSymbol]: ProMembersResponse;
        [dataTagErrorSymbol]: Error;
    };
};
/** Lowercased set of member usernames for O(1), case-insensitive membership checks. */
declare function proMembersSet(members?: string[]): Set<string>;
 ...
 */
declare function accountNameByteLength(value: string): number;
/**
 ...
 */
declare function isQueryableAccountName(value: string | undefined | null): boolean;
 ...
 */
declare function pickRicherMetadataSnapshot<T extends Pick<FullAccount, "posting_json_metadata">>(preferred: T | null | undefined, fallback: T | null | undefined): T | null | undefined;
/**
 ...
 */
declare function parsePostingMetadataRoot(postingJsonMetadata?: string | null): Record<string, unknown>;
/**
 ...
 */
declare function buildPostingJsonMetadata({ existingPostingJsonMetadata, profile, tokens, }: {
 ...
 */
declare function rewardsToStakeRatio(account: FullAccount): number | null;
 ...
 */
declare function normalizeTag(raw: unknown): string | null;
...
declare function getFragmentsQueryOptions(username: string, code?: string): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<Fragment[], Error, Fragment[], (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<Fragment[], (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
 ...
 */
declare function getUserPostVoteQueryOptions(username: string | undefined, author: string | undefined, permlink: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<Vote | null, Error, Vote | null, string[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<Vote | null, string[], never> | undefined;
} & {
    queryKey: string[] & {
...
declare function getPostHeaderQueryOptions(author: string, permlink: string): Omit<_tanstack_react_query.UseQueryOptions<Entry$1 | null, Error, Entry$1 | null, (string | undefined)[]>, "queryFn"> & {
    initialData: Entry$1 | (() => Entry$1 | null) | null;
    queryFn?: _tanstack_react_query.QueryFunction<Entry$1 | null, (string | undefined)[]> | undefined;
} & {
    queryKey: (string | undefined)[] & {
...
type WavesFeedEntry = WaveEntry & {
    _cursor?: string;
};
interface WavesFeedParams {
 ...
 */
declare function isVoteAlreadyReflected(activeVotes: Array<{
    voter: string;
}>, voter: string | undefined, weight: number): boolean;
/**
 ...
 */
declare function applyVoteCacheUpdate(username: string | undefined, variables: VotePayload, qc?: QueryClient): void;
/**
 ...
 */
declare function resolveContentActivityType(payload: Pick<CommentPayload, "parentAuthor" | "isUpdate">): 100 | 110 | null;
 ...
 */
declare namespace EntriesCacheManagement {
    function updateVotes(author: string, permlink: string, votes: EntryVote[], payout: number, qc?: QueryClient): void;
    function updateReblogsCount(author: string, permlink: string, count: number, qc?: QueryClient): void;
    function updateRepliesCount(author: string, permlink: string, count: number, qc?: QueryClient): void;
    function addReply(reply: Entry$1, parentAuthor: string, parentPermlink: string, qc?: QueryClient): void;
    function updateEntries(entries: Entry$1[], qc?: QueryClient): void;
    function invalidateEntry(author: string, permlink: string, qc?: QueryClient): void;
    function getEntry(author: string, permlink: string, qc?: QueryClient): Entry$1 | undefined;
}
 ...
 */
declare function addOptimisticDiscussionEntry(entry: Entry$1, rootAuthor: string, rootPermlink: string, qc?: QueryClient): void;
/**
 * Removes an entry from all discussions caches for the given root post.
 * Returns the previous state for rollback.
 */
declare function removeOptimisticDiscussionEntry(author: string, permlink: string, rootAuthor: string, rootPermlink: string, qc?: QueryClient): Map<readonly unknown[], Entry$1[]>;
/**
 * Restores discussion cache snapshots (for rollback on error).
 */
declare function restoreDiscussionSnapshots(snapshots: Map<readonly unknown[], Entry$1[]>, qc?: QueryClient): void;
/**
 * Updates a specific entry in the SDK entry cache.
 * Returns the previous entry for rollback.
 */
declare function updateEntryInCache(author: string, permlink: string, updates: Partial<Entry$1>, qc?: QueryClient): Entry$1 | undefined;
/**
 * Restores an entry in cache (for rollback on error).
 */
declare function restoreEntryInCache(author: string, permlink: string, entry: Entry$1, qc?: QueryClient): void;
 ...
 */
declare function parseJsonMetadata(value: unknown): Record<string, unknown> | null;
...
interface ThreeSpeakBeneficiaryRoute {
    account: string;
    weight: number;
    src?: string;
}
declare const THREESPEAK_BENEFICIARY_ACCOUNT = "threespeakfund";
/** Beneficiary weight in basis points: 1100 = 11%. */
declare const THREESPEAK_BENEFICIARY_WEIGHT = 1100;
/**
 ...
 */
declare function hasThreeSpeakEmbed(body: string): boolean;
/**
 ...
 */
declare function enforceThreeSpeakBeneficiary<T extends ThreeSpeakBeneficiaryRoute>(beneficiaries: T[], body: string): (T | ThreeSpeakBeneficiaryRoute)[];
/** Whether a beneficiary entry is the 3Speak route, which the UI locks from editing. */
declare function isThreeSpeakBeneficiary(account: string): boolean;
...
type RcResourceUsage = Record<RcResourceName, number>;
interface RcPricedUsage {
    cost: number;
 ...
 */
declare function priceRcUsage(usage: RcResourceUsage, rcParams: RcResourceParams, rcStats: Pick<RcStats, "pool" | "regen" | "share">): RcPricedUsage;
...
declare const TRANSACTION_HEADER_BYTES = 11;
declare const SIGNATURE_BYTES = 65;
declare const stringFieldBytes: (value: string) => number;
interface VoteLike {
    voter: string;
    author: string;
    permlink: string;
...
declare function estimateVoteTransactionBytes(op: VoteLike, signatures?: number): number;
/**
 * A vote's footprint is fixed: `vote_size` state bytes and `vote_time`
 * execution time, regardless of the post being voted on.
 */
declare function countVoteResourceUsage({ transactionBytes, signatures }: {
 ...
 */
type RcPrecheckOperation = keyof RcStats["ops"];
 ...
 * non-blocking.
 */
declare function estimateRcPrecheck({ rcAccount, rcStats, rcParams, operation, payload, fallback, buffer, }: RcPrecheckInput): RcPrecheckResult;
 ...
 */
declare function gameClaimRequest(code: string, gameType: "spin", key: string): Promise<GameClaim>;
...
type DailyQuest = DailyCheckinQuest | DailyContentQuest;
interface PeriodQuest {
    id: string;
    progress: number;
}
...
interface StreakFreezeBuyResult {
 ...
 */
declare function getQuestsQueryOptions(username: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<QuestsResponse, Error, QuestsResponse, (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<QuestsResponse, (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: QuestsResponse;
        [dataTagErrorSymbol]: Error;
    };
};
...
declare const QUEST_CATALOG: QuestCatalogEntry[];
declare function getQuestCatalogEntry(tier: QuestTier, id: string): QuestCatalogEntry | undefined;
/**
 ...
 */
declare const QUEST_MIN_CONTENT_LENGTH = 25;
/**
 ...
 */
declare function measureQuestContentLength(body: string | null | undefined): number;
/**
 ...
 */
declare function earnsQuestContentCredit(body: string | null | undefined): boolean;
declare const STREAK_FREEZE_PRICE = 300;
declare const STREAK_FREEZE_MAX_OWNED = 2;
 ...
 */
declare function buyStreakFreezeRequest(code: string): Promise<StreakFreezeBuyResult>;
/**
 ...
 */
declare function useBuyStreakFreeze(username: string | undefined, code: string | undefined): _tanstack_react_query.UseMutationResult<StreakFreezeBuyResult, Error, void, unknown>;

/**
 * Payload for subscribing to a community.
 */
interface SubscribeCommunityPayload {
 ...
 */
interface UnsubscribeCommunityPayload {
    /** Community name (e.g., "hive-123456") */
    community: string;
}
/**
 ...
 */
interface SetCommunityRolePayload {
 ...
 */
type UpdateCommunityPayload = CommunityProps;
/**
 ...
 */
interface CommunityRewardsRegisterPayload {
...
declare function getCommunitiesQueryOptions(sort: string, query?: string, limit?: number, observer?: string | undefined, enabled?: boolean): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<Communities, Error, Communities, (string | number)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<Communities, (string | number)[], never> | undefined;
} & {
    queryKey: (string | number)[] & {
 ...
 */
declare const SUBSCRIBERS_PAGE_SIZE = 100;
 ...
 */
declare function getCommunitySubscribersQueryOptions(communityName: string): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<SubscribersPage, Error, SubscribersPage, string[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<SubscribersPage, string[], never> | undefined;
} & {
    queryKey: string[] & {
        [dataTagSymbol]: SubscribersPage;
        [dataTagErrorSymbol]: Error;
    };
};
/**
 ...
 * @param communityName - The community name (e.g., "hive-123456")
 */
declare function getCommunitySubscribersInfiniteQueryOptions(communityName: string): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseInfiniteQueryOptions<SubscribersPage, Error, InfiniteData<SubscribersPage, SubscribersCursor>, string[], SubscribersCursor>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<SubscribersPage, string[], SubscribersCursor> | undefined;
} & {
    queryKey: string[] & {
        [dataTagSymbol]: InfiniteData<SubscribersPage, unknown>;
        [dataTagErrorSymbol]: Error;
    };
};
...
interface WsPayoutsNotification extends BaseWsNotification {
    type: "payouts";
    extra: {
        permlink: string;
        title: string | null;
...
interface ApiPayoutsNotification extends BaseAPiNotification {
    type: "payouts";
    author: string;
    permlink: string;
    title: string | null;
...
interface ApiScheduledPublishedNotification extends BaseAPiNotification {
...
interface ApiTagsPostNotification extends ApiTagsNotificationBase {
    tags: string[];
    author: string;
    permlink: string;
    title: string | null;
...
interface ApiTagsBundleNotification extends ApiTagsNotificationBase {
    tag: string;
    count: number;
    latest: {
        author: string;
...
declare function getSpotlightsQueryOptions(_accessToken?: string): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<Spotlight[], Error, Spotlight[], string[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<Spotlight[], string[], never> | undefined;
} & {
    queryKey: string[] & {
        [dataTagSymbol]: Spotlight[];
        [dataTagErrorSymbol]: Error;
    };
};
...
type HiveTransaction = Transaction;
 ...
 */
declare function getAccountDelegationsQueryOptions(username: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<AccountDelegations, Error, AccountDelegations, (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<AccountDelegations, (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: AccountDelegations;
        [dataTagErrorSymbol]: Error;
    };
};
 ...
 */
declare function collectRequestedOperations(filters: HiveOperationFilter): Set<string>;
/**
 ...
 * never terminates.
 */
declare function getNextAccountHistoryPageParam(lastPage: HiveTransaction[] | undefined): number | undefined;
/**
 ...
 */
declare function resolveAccountHistoryLimit(pageParam: number, limit: number): number;
declare function getHiveAssetTransactionsQueryOptions(username: string | undefined, limit?: number, filters?: HiveOperationFilter): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseInfiniteQueryOptions<Transaction[], Error, _tanstack_react_query.InfiniteData<Transaction[], unknown>, readonly unknown[], unknown>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<Transaction[], readonly unknown[], unknown> | undefined;
} & {
    queryKey: readonly unknown[] & {
        [dataTagSymbol]: _tanstack_react_query.InfiniteData<Transaction[], unknown>;
        [dataTagErrorSymbol]: Error;
    };
};

declare function getHbdAssetTransactionsQueryOptions(username: string | undefined, limit?: number, filters?: HiveOperationFilter): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseInfiniteQueryOptions<Transaction[], Error, _tanstack_react_query.InfiniteData<Transaction[], unknown>, readonly unknown[], unknown>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<Transaction[], readonly unknown[], unknown> | undefined;
} & {
    queryKey: readonly unknown[] & {
        [dataTagSymbol]: _tanstack_react_query.InfiniteData<Transaction[], unknown>;
...
declare function getHivePowerAssetTransactionsQueryOptions(username: string | undefined, limit?: number, filters?: HiveOperationFilter): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseInfiniteQueryOptions<Transaction[], Error, _tanstack_react_query.InfiniteData<Transaction[], unknown>, readonly unknown[], unknown>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<Transaction[], readonly unknown[], unknown> | undefined;
} & {
    queryKey: readonly unknown[] & {
        [dataTagSymbol]: _tanstack_react_query.InfiniteData<Transaction[], unknown>;
...
declare function getHiveAssetWithdrawalRoutesQueryOptions(username: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<WithdrawRoute[], Error, WithdrawRoute[], (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<WithdrawRoute[], (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: WithdrawRoute[];
        [dataTagErrorSymbol]: Error;
...
declare function getAccountWalletAssetInfoQueryOptions(username: string, asset: string, options?: Options$1): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<GeneralAssetInfo | undefined, Error, GeneralAssetInfo | undefined, string[]>, "queryFn"> & {
 ...
 */
interface DelegateVestingSharesPayload {
 ...
 */
interface SetWithdrawVestingRoutePayload {
 ...
 */
declare function claimPointsRequest(username: string | undefined, accessToken: string | undefined): Promise<any>;
...
declare const MAX_SEARCH_TAGS = 5;
declare const MAX_SEARCH_QUERY_LENGTH = 100;
/**
 ...
 */
declare function normalizeSearchAuthor(value: string): string;
declare function normalizeSearchCategory(value: string): string;
/**
 ...
 */
declare function normalizeSearchTags(value: string): string[];
 ...
 */
declare function buildSearchQuery({ search, author, type, category, tags }: SearchQueryParts): BuiltSearchQuery;
...
declare const SIMILAR_ENTRIES_MIN_RENDER = 2;
interface Entry {
    author: string;
    permlink: string;
    title?: string;
...
declare function similar(params: {
    author: string;
    permlink: string;
    title?: string;
    body?: string;
...
interface UpdateSupportSettingsPayload {
    beneficiary_percent: number;
    curation_percent: number;
}
 ...
 */
declare function getSupportSettingsRequest(code: string): Promise<SupportSettings>;
/**
 ...
 */
declare function getSupportSettingsQueryOptions(username: string | undefined, code: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<SupportSettings, Error, SupportSettings, (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<SupportSettings, (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: SupportSettings;
        [dataTagErrorSymbol]: Error;
    };
};
 ...
 * hook below wraps it.
 */
declare function updateSupportSettingsRequest(code: string, payload: UpdateSupportSettingsPayload): Promise<SupportSettings>;
/**
 ...
 */
declare function applySupportSettingsUpdate(queryClient: QueryClient, username: string, data: SupportSettings): Promise<void>;
/**
 ...
 * new preference.
 */
declare function useUpdateSupportSettings(username: string | undefined, code: string | undefined): _tanstack_react_query.UseMutationResult<SupportSettings, Error, UpdateSupportSettingsPayload, unknown>;
 ...
 * ({ duration, price }).
 */
declare function getRcDelegationPricesQueryOptions(accessToken: string): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<PromotePrice[], Error, PromotePrice[], string[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<PromotePrice[], string[], never> | undefined;
} & {
    queryKey: string[] & {
        [dataTagSymbol]: PromotePrice[];
 ...
 */
declare function getRcDelegationActiveQueryOptions(username: string, accessToken: string): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<RcDelegationActive | null, Error, RcDelegationActive | null, string[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<RcDelegationActive | null, string[], never> | undefined;
} & {
    queryKey: string[] & {
        [dataTagSymbol]: RcDelegationActive | null;
        [dataTagErrorSymbol]: Error;
    };
};
 ...
 */
declare function useRcDelegation(username: string | undefined, auth?: AuthContextV2, broadcastMode?: BroadcastMode): _tanstack_react_query.UseMutationResult<unknown, Error, RcDelegationPayload, unknown>;
...
declare function formattedNumber(value: number | string, options?: Options | undefined): string;
...
declare const HIDDEN_POST_RSHARES_THRESHOLD = -10000000000;
/** Downvoting is only conclusive once enough accounts have voted. */
declare const HIDDEN_POST_MIN_VOTES = 5;
/**
 ...
 */
declare const LOW_TRUST_REPUTATION_THRESHOLD = 30;
 ...
 */
declare enum ContentModerationReason {
    /**
...
declare function isHiddenPost(netRshares: number | undefined, activeVotesLength: number): boolean;
/**
 ...
 */
declare function isLowTrustSeoPost(content: Pick<ModerationCandidate, "author_reputation" | "body">): boolean;
/** True when the viewer has personally muted this author. */
declare function isAuthorMuted(author: string | undefined, mutedAuthors: string[] | undefined | null): boolean;
/**
 ...
 * than labelling it.
 */
declare function getContentModerationReason(content: ModerationCandidate | undefined | null): ContentModerationReason | null;
...
type NewsletterListType = "creator" | "community";
...
interface DigestSubscribeResult {
...
interface NewsletterPostRef {
    author: string;
    permlink: string;
}
/** One post, the post being the issue. */
interface NewsletterSendRef extends NewsletterPostRef {
    type: NewsletterListType;
    target: string;
}
/** Several posts with a subject and an intro. */
interface NewsletterComposeRequest {
    type: NewsletterListType;
    target: string;
...
type NewsletterSendRequest = NewsletterSendRef | NewsletterComposeRequest;
interface NewsletterCandidatePost extends NewsletterPostRef {
    title: string;
    created: string;
    featured: boolean;
}
interface NewsletterSendPreview {
    subject: string;
    html: string;
    text: string;
    post: {
...
interface NewsletterSenderStanding {
    type: DigestType;
    target: string;
 ...
 */
declare function subscribeDigestRequest(input: DigestSubscribeInput, code?: string): Promise<DigestSubscribeResult>;
/** Every live digest subscription attributed to the token's account. */
declare function getDigestSubscriptionsRequest(code: string): Promise<DigestSubscription[]>;
/** Leave one digest by subscription id. */
declare function leaveDigestRequest(id: string, code: string): Promise<void>;
/**
 ...
 */
declare function unsubscribeAllDigestsRequest(email: string, code: string): Promise<void>;
/** Sender standing (status, complaint/bounce stats, subscriber counts) for a list. */
declare function getNewsletterSenderRequest(type: NewsletterListType, target: string, code: string): Promise<NewsletterSenderStanding>;
/** Already-sent issues for a list, newest first. */
declare function getNewsletterIssuesRequest(type: NewsletterListType, target: string, code: string): Promise<NewsletterSentIssue[]>;
/** Candidate posts for composing a digest issue. */
declare function getNewsletterPostsRequest(type: NewsletterListType, target: string, code: string, limit?: number): Promise<NewsletterCandidatePost[]>;
/** Render the would-be issue (subject/html/text, counts, taken periods) without sending. */
declare function previewNewsletterSendRequest(request: NewsletterSendRequest, code: string): Promise<NewsletterSendPreview>;
/** Send a post or composed digest to the list's subscribers. Pro/team gated by the relay. */
declare function sendNewsletterIssueRequest(request: NewsletterSendRequest, code: string): Promise<NewsletterSendResult>;
 ...
 */
declare function getDigestSubscriptionsQueryOptions(username: string | undefined, code: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<DigestSubscription[], Error, DigestSubscription[], (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<DigestSubscription[], (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
 ...
 */
declare function getNewsletterSenderQueryOptions(type: NewsletterListType, target: string, username: string | undefined, code: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<NewsletterSenderStanding, Error, NewsletterSenderStanding, (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<NewsletterSenderStanding, (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: NewsletterSenderStanding;
        [dataTagErrorSymbol]: Error;
    };
};

/** Already-sent issues for a creator/community list (sender-only view). */
declare function getNewsletterIssuesQueryOptions(type: NewsletterListType, target: string, username: string | undefined, code: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<NewsletterSentIssue[], Error, NewsletterSentIssue[], (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<NewsletterSentIssue[], (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: NewsletterSentIssue[];
        [dataTagErrorSymbol]: Error;
    };
};

/** Candidate posts for composing a digest issue (send-gated by the relay). */
declare function getNewsletterPostsQueryOptions(type: NewsletterListType, target: string, username: string | undefined, code: string | undefined, limit?: number): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<NewsletterCandidatePost[], Error, NewsletterCandidatePost[], (string | number | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<NewsletterCandidatePost[], (string | number | undefined)[], never> | undefined;
} & {
    queryKey: (string | number | undefined)[] & {
        [dataTagSymbol]: NewsletterCandidatePost[];
        [dataTagErrorSymbol]: Error;
    };
};
 ...
 */
declare function useSubscribeDigest(username: string | undefined, code: string | undefined): _tanstack_react_query.UseMutationResult<DigestSubscribeResult, Error, DigestSubscribeInput, unknown>;

/** Leave one digest by subscription id; drops the row from the cached list. */
declare function useLeaveDigest(username: string | undefined, code: string | undefined): _tanstack_react_query.UseMutationResult<void, Error, string, unknown>;
 ...
 */
declare function useUnsubscribeAllDigests(username: string | undefined, code: string | undefined): _tanstack_react_query.UseMutationResult<void, Error, string, unknown>;

/**
 * Preview the would-be issue. No cache side effects: a preview changes
 * nothing server-side.
 */
declare function usePreviewNewsletterIssue(username: string | undefined, code: string | undefined): _tanstack_react_query.UseMutationResult<NewsletterSendPreview, Error, NewsletterSendRequest, unknown>;
/**
 ...
 */
interface CurationHandoffEntry {
    username: string;
 ...
 */
interface CurationRosterAdminEntry extends CurationRosterEntry {
 ...
 */
type CurationApplicationVoteValue = "endorse" | "object" | "abstain";
/** One reviewer's line on one application. Private to the review queue. */
interface CurationApplicationVote {
    voter: string;
...
interface CurationApplicationTally {
    endorsed: number;
    objected: number;
}
/**
 ...
 */
interface CurationApplicationAdminEntry extends CurationApplication {
 ...
 */
interface CurationApplicationQueueEntry extends CurationApplicationAdminEntry {
...
interface CurationApplicationMine {
...
interface CurationApplicationList {
...
interface CurationApplicationVoteInput {
    applicant: string;
    vote: CurationApplicationVoteValue;
    note?: string;
}
interface CurationApplicationVoteResult {
...
interface CurationApplicationDecideInput {
    applicant: string;
...
interface CurationRosterSetInput {
    curator: string;
    role: CurationRole;
 ...
 */
declare function curationRosterListRequest(code: string | undefined, signal?: AbortSignal): Promise<CurationRosterAdminList>;
declare function curationRosterSetRequest(code: string | undefined, input: CurationRosterSetInput): Promise<{
    curator: CurationRosterAdminEntry;
}>;
declare function curationRosterRetireRequest(code: string | undefined, curator: string): Promise<{
    ok: boolean;
    curator: string;
}>;
declare function curationApplicationApplyRequest(code: string | undefined, answers: {
    motivation: string;
    availability: string;
    pick: string;
}): Promise<{
...
declare function curationApplicationMineRequest(code: string | undefined, signal?: AbortSignal): Promise<CurationApplicationMine>;
declare function curationApplicationWithdrawRequest(code: string | undefined): Promise<{
    application: CurationApplication;
}>;
declare function curationApplicationListRequest(code: string | undefined, params?: {
    state?: CurationApplicationState;
    limit?: number;
}, signal?: AbortSignal): Promise<CurationApplicationList>;
declare function curationApplicationDecideRequest(code: string | undefined, input: CurationApplicationDecideInput): Promise<{
    application: CurationApplication;
}>;
declare function curationApplicationVoteRequest(code: string | undefined, input: CurationApplicationVoteInput): Promise<CurationApplicationVoteResult>;
declare function curationApplicationWindowRequest(code: string | undefined, input: {
    open?: boolean;
    message?: string | null;
    quorum?: number;
    term_days?: number;
 ...
 */
declare function getCurationRosterAdminQueryOptions(username: string | undefined, code: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<CurationRosterAdminList, Error, CurationRosterAdminList, (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<CurationRosterAdminList, (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: CurationRosterAdminList;
        [dataTagErrorSymbol]: Error;
    };
};
 ...
 */
declare function getCurationApplicationQueryOptions(username: string | undefined, code: string | undefined): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<CurationApplicationMine, Error, CurationApplicationMine, (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<CurationApplicationMine, (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: CurationApplicationMine;
        [dataTagErrorSymbol]: Error;
    };
};
 ...
 */
declare function getCurationApplicationsQueryOptions(username: string | undefined, code: string | undefined, state?: CurationApplicationState): _tanstack_react_query.OmitKeyof<_tanstack_react_query.UseQueryOptions<CurationApplicationList, Error, CurationApplicationList, (string | undefined)[]>, "queryFn"> & {
    queryFn?: _tanstack_react_query.QueryFunction<CurationApplicationList, (string | undefined)[], never> | undefined;
} & {
    queryKey: (string | undefined)[] & {
        [dataTagSymbol]: CurationApplicationList;
        [dataTagErrorSymbol]: Error;
    };
};
